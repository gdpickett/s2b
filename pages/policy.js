...
export default function Page () {
  return (
    <Layout>
      ...
      <p>
        THE SOFTWARE IS PROVIDED `&ldquo`AS IS`&ldquo`, WITHOUT WARRANTY OF ANY KIND, EXPRESS OR
      ...
      <p>
        Data provided to this site is exclusively used to support signing in or using the 
